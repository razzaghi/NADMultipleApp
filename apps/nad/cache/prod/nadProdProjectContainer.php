...
class nadProdProjectContainer extends Container
{
    private $parameters;
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a87d8229ed8c52e1730e1a4eaa5d591c7ab7242ab8ff3d8cee8f1e70f46f02f7');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[4].'/src/NAD/DefaultBundle/Resources/views'), 'NADDefault');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55c68dd273aa24.09661891')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NADDefaultBundle' => 'NAD\\DefaultBundle\\NADDefaultBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'nadProdProjectContainer',
            ...
            'router.options.matcher.cache_class' => 'nadProdUrlMatcher',
            'router.options.generator.cache_class' => 'nadProdUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[2].'/config/routing.yml'),
            'router.cache_class_prefix' => 'nadProd',
